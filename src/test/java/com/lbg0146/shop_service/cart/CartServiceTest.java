...
public class CartServiceTest {
    ...
    void 장바구니에_상품을_추가() {
        ...
        CartItemCreateRequest request = new CartItemCreateRequest(product.getId(), 2);
    ...
    void 같은_상품을_다시_추가하면_수량이_증가() {
        ...
        CartItemCreateRequest firstRequest = new CartItemCreateRequest(product.getId(), 2);

        CartItemCreateRequest secondRequest = new CartItemCreateRequest(product.getId(), 3);
    ...
    void 다른_상품을_추가하면_새로운_CartItem이_생성() {
        ...
        CartItemCreateRequest request1 = new CartItemCreateRequest(
                product1.getId(),
                2
        );

        CartItemCreateRequest request2 = new CartItemCreateRequest(
                product2.getId(),
                1
        );
    ...
    void 장바구니_상품_수량을_변경() {
        ...
        CartItemCreateRequest createRequest = new CartItemCreateRequest(
                product.getId(),
                2
        );
